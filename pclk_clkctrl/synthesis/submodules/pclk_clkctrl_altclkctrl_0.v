...
module  pclk_clkctrl_altclkctrl_0_sub
	( 
	ena,
	inclk,
...
`endif
	...
	assign
		clkselect = {2{1'b0}},
		outclk = wire_sd1_outclk;
endmodule //pclk_clkctrl_altclkctrl_0_sub
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module  pclk_clkctrl_altclkctrl_0  (
    inclk,
    outclk);
    ...
    pclk_clkctrl_altclkctrl_0_sub  pclk_clkctrl_altclkctrl_0_sub_component (
                .ena (sub_wire1),
                .inclk (sub_wire3),
                .outclk (sub_wire0));
