...
add_fileset_file bilateral_filter_3x1.sv SYSTEM_VERILOG PATH disparity_filtering/bilateral_filter_3x1.sv
add_fileset_file bram_addr_calc.sv SYSTEM_VERILOG PATH disparity_filtering/bram_addr_calc.sv
add_fileset_file bram_filter_control_fsm.sv SYSTEM_VERILOG PATH disparity_filtering/bram_filter_control_fsm.sv
add_fileset_file bram_filter_system.sv SYSTEM_VERILOG PATH disparity_filtering/bram_filter_system.sv
add_fileset_file bram_reader_out.sv SYSTEM_VERILOG PATH disparity_filtering/bram_reader_out.sv
add_fileset_file bram_writer_2in.sv SYSTEM_VERILOG PATH disparity_filtering/bram_writer_2in.sv
add_fileset_file filt_bram_reader_writer.sv SYSTEM_VERILOG PATH disparity_filtering/filt_bram_reader_writer.sv
add_fileset_file pipelined_divide_15n_10d.v VERILOG PATH disparity_filtering/pipelined_divide_15n_10d.v
add_fileset_file bram_wrapper.sv SYSTEM_VERILOG PATH bram_wrapper.sv
add_fileset_file downsample_1d.sv SYSTEM_VERILOG PATH disparity_filtering/downsample_1d.sv
add_fileset_file dual_bram_module.sv SYSTEM_VERILOG PATH disparity_filtering/dual_bram_module.sv
...
add_interface_port disparity_left_source disparity_ready_left ready Input 1
...
add_interface_port disparity_right_source disparity_ready_right ready Input 1


# 
# connection point gray_left_sink
# 
add_interface gray_left_sink avalon_streaming end
set_interface_property gray_left_sink associatedClock clock_sink
set_interface_property gray_left_sink associatedReset reset_sink
set_interface_property gray_left_sink dataBitsPerSymbol 8
set_interface_property gray_left_sink errorDescriptor ""
set_interface_property gray_left_sink firstSymbolInHighOrderBits true
set_interface_property gray_left_sink maxChannel 0
set_interface_property gray_left_sink readyLatency 0
set_interface_property gray_left_sink ENABLED true
set_interface_property gray_left_sink EXPORT_OF ""
set_interface_property gray_left_sink PORT_NAME_MAP ""
set_interface_property gray_left_sink CMSIS_SVD_VARIABLES ""
set_interface_property gray_left_sink SVD_ADDRESS_GROUP ""

add_interface_port gray_left_sink gray_pixel_left_valid valid Input 1
add_interface_port gray_left_sink gray_pixel_left_ready ready Output 1
add_interface_port gray_left_sink gray_pixel_left_data data Input 8


# 
# connection point gray_right_sink
# 
add_interface gray_right_sink avalon_streaming end
set_interface_property gray_right_sink associatedClock clock_sink
set_interface_property gray_right_sink associatedReset reset_sink
set_interface_property gray_right_sink dataBitsPerSymbol 8
set_interface_property gray_right_sink errorDescriptor ""
set_interface_property gray_right_sink firstSymbolInHighOrderBits true
set_interface_property gray_right_sink maxChannel 0
set_interface_property gray_right_sink readyLatency 0
set_interface_property gray_right_sink ENABLED true
set_interface_property gray_right_sink EXPORT_OF ""
set_interface_property gray_right_sink PORT_NAME_MAP ""
set_interface_property gray_right_sink CMSIS_SVD_VARIABLES ""
set_interface_property gray_right_sink SVD_ADDRESS_GROUP ""

add_interface_port gray_right_sink gray_pixel_right_data data Input 8
add_interface_port gray_right_sink gray_pixel_right_valid valid Input 1
add_interface_port gray_right_sink gray_pixel_right_ready ready Output 1
